...
- **misc**: Add "onAvatarsClick" prop to ChatList component.
...
- **misc**: Rename usePressSpeechRecognition to usePersistedSpeechRecognition.
...
- **misc**: Refactor promise to edge speech.
...
- **misc**: Add onDoubleClick prop to multiple components.
...
- **misc**: Avatar base64 src, Type, Typo.
...
- **misc**: Remove dependency "rehype-raw".
...
- **misc**: Replace static `prefixCls` with dynamic `prefixCls`.
...
- **misc**: Fix highlight and use bun in workflow.
...
- **misc**: Add showSearch prop to select component, and extand langs.
...
- **misc**: Introduce SelectWithImg component and export various components.
...
- **misc**: Update generateCustomStylish.ts.
...
- **misc**: Update dependencies and import modules for package.json, SyntaxHighlighter, Markdown component, and useHighlight hook.
