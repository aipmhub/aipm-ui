...
const LogoFlat = memo<SvgProps & DivProps & { size?: number }>(
  ({ size = '1em', style, ...rest }) => {
    return (
      <svg
        height={size}
      ...
      >
        ...
        <path
          ...
          fill="#A68AE2"
        ></path>
        <path d="M5.669 1.025a.778.778 0 11-1.557 0 .778.778 0 011.557 0z" fill="#7B61FF"></path>
        <path d="M4.686 8.192a1.31 1.31 0 11-2.621 0 1.31 1.31 0 012.62 0z" fill="#F24630"></path>
        <path d="M21.968 3.4a1.27 1.27 0 11-2.539 0 1.27 1.27 0 012.54 0z" fill="#7CEE1D"></path>
        <path
