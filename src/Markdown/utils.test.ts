...
describe('escapeDollarNumber', () => {
  it('should escape dollar signs followed by numbers', () => {
    ...
    expect(escapeDollarNumber('I have $20 and you have $30')).toBe(
      'I have \\$20 and you have \\$30',
    );
  });

  it('should not escape dollar signs in code blocks', () => {
    expect(escapeDollarNumber('```\n$10\n```')).toBe('```\n$10\n```');
    expect(escapeDollarNumber('This is a inline code block: `$10`')).toBe(
      'This is a inline code block: `$10`',
    );
  });

  it('should handle multiple cases', () => {
    expect(escapeDollarNumber('This costs $10. But this code is fine: `$10`.')).toBe(
      'This costs \\$10. But this code is fine: `$10`.',
    );
  });
